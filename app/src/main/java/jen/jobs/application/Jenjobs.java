...
public class Jenjobs {
    ...
    public static final String ACCESS_LEVEL = "http://api.jenjobs.com/jobseeker/access-level";
    ...
    public static final String ADDITIONAL_INFO = "http://api.jenjobs.com/jobseeker/additional-info";
    public static final String JOBSEEKING_INFO = "http://api.jenjobs.com/jobseeker/jobseeking-info";
    ...
    public static final String CHANGE_PASSWORD_URL = "http://api.jenjobs.com/jobseeker/update-password";
