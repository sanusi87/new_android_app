...
public class TableBookmark extends SQLiteOpenHelper{
    ...
    */
    private static String SQL_CREATE_ENTRIES = "CREATE TABLE '"+TableBookmark.TABLE_NAME
            +"' (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " +
            "post_id INTEGER, " +
            "title TEXT, " +
            "date_added NUMERIC, " +
            "date_closed NUMERIC);";
    private static String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS '"+TableBookmark.TABLE_NAME+"'";
