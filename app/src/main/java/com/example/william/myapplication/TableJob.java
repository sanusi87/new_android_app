...
public class TableJob extends SQLiteOpenHelper{
    ...
    private static String SQL_CREATE_ENTRIES = "CREATE TABLE '"+TableJob.TABLE_NAME+"' (salary INTEGER, " +
            "currency_id INTEGER, " +
            "state_id TEXT, " +
            "country_id TEXT, " +
            "job_type_id TEXT)";
    private static String SQL_DELETE_ENTRIES = "DROP TABLE IF EXISTS '"+TableJob.TABLE_NAME+"'";
